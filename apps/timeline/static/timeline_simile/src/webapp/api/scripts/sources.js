                 ...
                 description: description,
                  ...
                  tapeRepeat: node.getAttribute("tapeRepeat"),
                    ...
                    trackNum: node.getAttribute("trackNum"),
                       votes: node.getAttribute("votes"),
                       db_id: node.getAttribute("db_id"),
                 ...
                 description: bindings["description"],
                  ...
                  tapeRepeat: bindings["tapeRepeat"],
                    ...
                    trackNum: bindings["trackNum"],
                       votes: bindings["votes"],
                       db_id: bindings["db_id"],
                        tags: bindings["tags"]
            });
...
Timeline.DefaultEventSource.Event = function(args) {
  ...
  //
  // Edits by alvarom (collaborative functionality):
  // 
  //   db_id        -- id of event in collaborative timeline application database, link for Django
  //   votes        -- positive integer recording the number of importance upvotes an event has received
  //   tags         -- a list of keyword tags assigned to an event
  ...
  this._votes = args.votes;
  this._db_id = args.db_id;
...
Timeline.DefaultEventSource.Event.prototype = {
    ...
    getVotes:       function() { return this._votes; },
    getDbId:        function() { return this._db_id; },
